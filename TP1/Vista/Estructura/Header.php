            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="1.form.php">Ejercicio 1</a></li>
                        <li><a class="dropdown-item" href="2.form.php">Ejercicio 2</a></li>
                        <li><a class="dropdown-item" href="3.form.php">Ejercicio 3</a></li>
                        <li><a class="dropdown-item" href="4.form.php">Ejercicio 4</a></li>
                        <li><a class="dropdown-item" href="5.form.php">Ejercicio 5</a></li>
                        <li><a class="dropdown-item" href="6.form.php">Ejercicio 6</a></li>
                        <li><a class="dropdown-item" href="7.form.php">Ejercicio 7</a></li>
                        <li><a class="dropdown-item" href="8.form.php">Ejercicio 8</a></li>
                    </ul>
                </li>
                <!-- TP2 -->
                <li class="nav-item dropdown">
